...
public class RuleData {
   ...
   private void setGroupRules()
   {
       ...
       groupRules.add(new Rule("BlackJack",
               "Chaque joueur va pouvoir additioner des valeurs aléatoires entre 1 et 13 . Le joueur qui se rapproche le plus de la valeur 21 sans la dépasser gagne 3 points et 3 gorgées à distribuer.",
               3,BLACKJACK));
